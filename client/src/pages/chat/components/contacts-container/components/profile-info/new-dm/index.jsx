    ...
    <>
      ...
      <Dialog open={OpenNewContactModal} onOpenChange={setOpenNewContactModal}>
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContact.length <= 0 && (
            <div className="flex-1 md:bg-transparent md:flex  mt-5 md:mt-0 flex-col justify-center items-center hidden duration-1000 transition-all">
              <Lottie
              ...
              />
              <div className="text-opacity-80 text-white flex mt-5  flex-col gap-5 items-center  lg:text-2xl text-xl transition-all duration-300 text-center ">
